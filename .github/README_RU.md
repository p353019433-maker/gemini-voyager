...
> [!IMPORTANT]
> **Веб-интерфейс Gemini был значительно переработан** — я адаптируюсь. Функции, на которые это может повлиять: **автоматический выбор модели по умолчанию** и **интерфейс папок**. В целом использование не должно сильно пострадать; если вы заметите другие отклонения, откройте issue на GitHub, и я постараюсь исправить как можно скорее. Дождитесь обновления в Chrome Web Store. _(2026-05-19)_
